...
#########################
# Score: 17/15
# Fantastic code, show this to your friends! I really like your helper function PlotFromNumbers()
# because its a good demonstration of D.R.Y (Don't Repeat Yourself), by wrapping that repetitive
# sequence of commands into a function call.
